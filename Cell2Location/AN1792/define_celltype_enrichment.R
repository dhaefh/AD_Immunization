...
# Summary: Define cell type enrichment using Cell2Location predicted cell type abundance
#
#-------------------------------------------------------------------------------
# Initialization
...
write.csv(meta, "/projects/b1042/Gate_Lab/anne/AN1792_rebuttal/cell2location/mapping/q05_meta_with_enrichment.csv")
