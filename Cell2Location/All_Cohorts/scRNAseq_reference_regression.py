...
# Summary: Estimate scRNAseq cell type signatures with Cell2Location
#
#-------------------------------------------------------------------------------
# Initialization
...
# Load scRNAseq reference anndata object
ref = sc.read_h5ad('/path/to/scRNAseq/ref.h5ad')
...
cell2location.models.RegressionModel.setup_anndata(adata=ref,
                                                   batch_key='sample_merged',
                                                   labels_key='fine_celltype_final')
mod = RegressionModel(ref)
mod.view_anndata_setup() 

# Train model  
mod.train(max_epochs=750, accelerator='gpu', batch_size = 2500, train_size = 1, lr=0.002) 
