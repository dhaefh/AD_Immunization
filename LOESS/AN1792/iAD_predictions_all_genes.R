...
# Summary: Generate LOESS predictions for iAD gene expression based on Aß density in the Aß plaque niche
#
#-------------------------------------------------------------------------------
...
# Subset for iAD and nAD Aß-rich spots and first + second order neighbors in gray matter
