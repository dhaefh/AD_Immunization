...
output_dir <- paste0("/path/to/clustering/output/cca_immune_pool_merged_", res, "/")
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

# Load integrated scRNAseq immune Seurat object and recorrect SCT data
...
s$clusters <- s@meta.data[[paste0("cca_snn30pcs_res.", res)]]
Idents(s) <- "clusters"
