...
output_folder <- "/path/to/amyloid/all/regions/mast/output/folder/"
...
zlm_group <- zlm(~ group_de + manual_layer + cdr_centered + gDNA_centered + region + (1 | sample_id), sca, ebayes = FALSE, method = "glmer")
...
# Save results
write.csv(results, paste0(output_folder, "results/amyloid_rich.csv"))
