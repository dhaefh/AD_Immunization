...
# Summary: Differential expression with DESeq2 for C2L enriched cell types in gray matter
#
#-------------------------------------------------------------------------------
...
comparisons <- c("ext_vs_nAD", "lim_vs_nAD", "iAD_vs_nAD", "NNC_vs_nAD", "nAD_vs_NNC", "lim_vs_ext", "ext_vs_lim")
