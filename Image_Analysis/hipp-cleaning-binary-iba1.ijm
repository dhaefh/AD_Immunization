...
function iba1Processing(bleach, raw, binaryPath, output) {
	...
	cleanedIba1BleachedOutput = output + "bleached-iba1-w-cleaned-binary-overlay/";
	cleanedIba1RawOutput = output + "raw-iba1-w-cleaned-binary-overlay/";
	cleanedBinaryIba1Output = output + "cleaned-binary-iba1-bleach-corrected-background-subtracted/"
	...
	for (i = 0; i < bleachedImages.length; i++) {
		...
		print("Created cleaned raw image");
...
rawDir = "/projects/b1042/Gate_Lab/alex/an1792-rebuttal-hippocampal/iba1-3/";
bleachedDir = "/projects/b1042/Gate_Lab/alex/an1792-rebuttal-hippocampal/iba1-3-bleach-corrected-after-stitching/";
binaryDir = "/projects/b1042/Gate_Lab/alex/an1792-rebuttal-hippocampal/iba1-3-manual-threshold/";
outputDir = "/projects/b1042/Gate_Lab/alex/an1792-rebuttal-hippocampal/iba1-3/";
