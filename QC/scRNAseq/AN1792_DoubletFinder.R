...
# Summary: Doublet detection for AN1792 with DoubletFinder 
#
#-------------------------------------------------------------------------------
...
# Estimated multiplet rates per pool
doublet_formation_rates <- c(0.064, 0.064)
names(doublet_formation_rates) <- c("pool1", "pool2")
