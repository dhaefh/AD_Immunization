...
# Summary: Pre-DoubletFinder QC filtering for lecanemab with Seurat
#
#-------------------------------------------------------------------------------
...
# Calculate general QC metrics per sample: strict min, flexible max for number of genes and UMI counts, strict MT max based on 10X recommendations https://www.10xgenomics.com/analysis-guides/common-considerations-for-quality-control-filters-for-single-cell-rna-seq-data
